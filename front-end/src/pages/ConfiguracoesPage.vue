  ...
  <q-page class="q-pa-md">
    ...
    <div class="row q-gutter-md">
      ...
      <div class="col-12 col-md-6">
        <q-card>
          <q-card-section>
            <div class="text-h6 q-mb-md">Preferências</div>
            <q-list>
              <q-item tag="label" v-ripple>
                <q-item-section>
                  <q-item-label>Notificações por email</q-item-label>
                  <q-item-label caption>Receber alertas por email</q-item-label>
                </q-item-section>
                <q-item-section side>
                  <q-toggle v-model="preferencias.emailNotif" />
                </q-item-section>
              </q-item>
              ...
              <q-item tag="label" v-ripple>
                <q-item-section>
                  ...
                  <q-item-label caption>Ativar tema escuro</q-item-label>
                </q-item-section>
                <q-item-section side>
                  <q-toggle v-model="preferencias.darkMode" />
                </q-item-section>
              </q-item>
            </q-list>
          </q-card-section>
